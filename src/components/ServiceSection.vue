<template>
    <section class="text-white mt-20" id="services">
        ...
        <div
            ...
            <div v-for="service in services" :key="service.slug" data-aos="fade-up"
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray pt-4 text-sm group-hover:text-white md:text-base">
                        <span
                            v-html="langs(`services.${service.slug}.description`).replace('Flutter', '<span class=\'text-blue-500\'>Flutter</span>').replace('Vue.js', '<span class=\'text-green-500\'>Vue.js</span>')"></span>
                    </p>
